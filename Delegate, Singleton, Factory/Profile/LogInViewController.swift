...
class LogInViewController: UIViewController, UITextFieldDelegate {
    ...
    @objc func logInPressed() {
        #if DEBUG
        let logInProfile = ProfileViewController(userService: CurrentUserService(name: <#String#>, avatar: <#String#>, status: <#String#>).userNick(name: login.text!) as! UserService, userName: login.text!)
